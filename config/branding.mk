...
CUSTOM_PLATFORM_VERSION := 12

TARGET_PRODUCT_SHORT := $(subst aosp_,,$(CUSTOM_BUILD))

CUSTOM_VERSION := RohieOS_$(CUSTOM_BUILD)-$(CUSTOM_PLATFORM_VERSION)-CAF-$(CUSTOM_BUILD_DATE)-$(ROHIE_BUILD_TYPE)-Alpha
CUSTOM_VERSION_PROP := s
